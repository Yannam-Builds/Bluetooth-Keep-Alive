<p align="center">
  <img src="./assets/hero.svg" width="100%" alt="Bluetooth Keep-Alive — native Windows tray utility">
</p>
...
<p align="center">
  <img src="./assets/sine-lab.svg" width="100%" alt="Animated sine-wave laboratory showing the Bluetooth keep-alive signal, sample playhead, selectable frequency, and seamless loop">
</p>
...
<p align="center">
  <img src="./assets/signal-flow.svg" width="100%" alt="Animated signal flow from the sine-wave buffer through winmm to the Bluetooth output">
</p>
...
<p align="center">
  <img src="./assets/live-status.svg" width="100%" alt="Animated status footer: signal active, native Windows utility, zero dependencies and zero telemetry">
</p>
